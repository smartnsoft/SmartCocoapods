Pod::Spec.new do |s|
  ...
  s.author = 'MBrand Inc.'
  s.source = { :http => "http://shared.smartnsoft.com/ios4me-ext/SmartAdServer-iOS-SDK-4.0.1.zip" }
  s.platform = :ios
  ...
  s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/SmartAdServer/SmartAdServer"' }
end