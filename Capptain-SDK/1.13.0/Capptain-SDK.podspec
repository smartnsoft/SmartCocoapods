Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://dl.dropboxusercontent.com/u/135185/SmartLibs/Capptain-SDK/#{s.version}/capptain-sdk-ios-#{s.version}.zip" }
  s.platform = :ios
  
  s.resource = "capptain-sdk-ios-#{s.version}/CapptainReach/res/*.*"
  
  s.source_files = 'capptain-sdk-ios-#{s.version}/CapptainSDK/**/*.h', 'capptain-sdk-ios-#{s.version}/CapptainReach/**/*.h'
  ...
  s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/Capptain-SDK/capptain-sdk-ios-#{s.version}/**"' }
end